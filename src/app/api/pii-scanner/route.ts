...
interface PiiDetectionResult {
  ...
  isSpecialCategory: boolean; // DPDP § special categories (health, biometric, etc.)
  regulation: string;
  reason: string;
}
...
const PII_RULES: PiiRule[] = [
  // ── Indian Government IDs ────────────────────────────────────────────────
  {
    ...
    dpdpCategory: "Personal Data — Govt Identifier (DPDP §4)",
    isSpecialCategory: false,
    regulation: "DPDP Act 2023 §4 · IT Rules 2011 Rule 3",
    confidence: "HIGH",
  ...
  },
  {
    ...
    dpdpCategory: "Personal Data — Govt Identifier (DPDP §4)",
    isSpecialCategory: false,
    regulation: "DPDP Act 2023 §4 · Income Tax Act §139A",
    confidence: "HIGH",
  ...
  },
  {
    ...
    dpdpCategory: "Personal Data — Business Identifier (DPDP §4)",
    isSpecialCategory: false,
    regulation: "DPDP Act 2023 §4 · GST Act",
    confidence: "HIGH",
  ...
  // ── Biometric ────────────────────────────────────────────────────────────
  {
    ...
    dpdpCategory: "Sensitive Personal Data — Biometric (DPDP §8)",
    isSpecialCategory: true,
    regulation: "DPDP Act 2023 §8 · IT (SPDI) Rules 2011",
    confidence: "HIGH",
  ...
  // ── Health & Medical ─────────────────────────────────────────────────────
  {
    ...
    dpdpCategory: "Sensitive Personal Data — Health (DPDP §8)",
    isSpecialCategory: true,
    regulation: "DPDP Act 2023 §8 · IT (SPDI) Rules 2011",
    confidence: "HIGH",
  ...
  // ── Financial ────────────────────────────────────────────────────────────
  {
    ...
    dpdpCategory: "Sensitive Personal Data — Financial (DPDP §8 / IT SPDI)",
    isSpecialCategory: true,
    regulation: "DPDP Act 2023 §8 · IT (SPDI) Rules 2011 · RBI Guidelines",
    confidence: "HIGH",
  ...
  },
  {
    ...
    dpdpCategory: "Sensitive Personal Data — Financial (DPDP §8)",
    isSpecialCategory: true,
    regulation: "DPDP Act 2023 §8 · PCI-DSS · RBI",
    confidence: "HIGH",
  ...
  },
  {
    ...
    dpdpCategory: "Sensitive Personal Data — Financial (DPDP §8)",
    isSpecialCategory: true,
    regulation: "DPDP Act 2023 §8 · RBI",
    confidence: "HIGH",
  ...
  },
  {
    ...
    dpdpCategory: "Personal Data — Financial (DPDP §4)",
    isSpecialCategory: false,
    regulation: "DPDP Act 2023 §4",
    confidence: "MEDIUM",
  ...
  },
  {
    ...
    dpdpCategory: "Personal Data — Financial (DPDP §4)",
    isSpecialCategory: false,
    regulation: "DPDP Act 2023 §4 · CICRA 2005",
    confidence: "HIGH",
  ...
  // ── Contact Information ──────────────────────────────────────────────────
  {
    ...
    dpdpCategory: "Personal Data — Contact (DPDP §4)",
    isSpecialCategory: false,
    regulation: "DPDP Act 2023 §4",
    confidence: "HIGH",
  ...
  },
  {
    ...
    dpdpCategory: "Personal Data — Contact (DPDP §4)",
    isSpecialCategory: false,
    regulation: "DPDP Act 2023 §4 · TRAI",
    confidence: "HIGH",
  ...
  // ── Identity & Demographics ──────────────────────────────────────────────
  {
    ...
    dpdpCategory: "Personal Data — Identity (DPDP §4)",
    isSpecialCategory: false,
    regulation: "DPDP Act 2023 §4",
    confidence: "MEDIUM",
  ...
  },
  {
    ...
    dpdpCategory: "Personal Data — Demographics (DPDP §4)",
    isSpecialCategory: false,
    regulation: "DPDP Act 2023 §4",
    confidence: "MEDIUM",
  ...
  },
  {
    ...
    dpdpCategory: "Sensitive Personal Data — Social (DPDP §8)",
    isSpecialCategory: true,
    regulation: "DPDP Act 2023 §8 · Constitution of India Art. 15",
    confidence: "HIGH",
  ...
  },
  {
    ...
    dpdpCategory: "Sensitive Personal Data — Political (DPDP §8)",
    isSpecialCategory: true,
    regulation: "DPDP Act 2023 §8 · GDPR Art. 9",
    confidence: "HIGH",
  ...
  // ── Digital Identifiers ──────────────────────────────────────────────────
  {
    ...
    dpdpCategory: "Personal Data — Digital Identifier (DPDP §4)",
    isSpecialCategory: false,
    regulation: "DPDP Act 2023 §4 · EU AI Act",
    confidence: "MEDIUM",
  ...
  },
  {
    ...
    isSpecialCategory: false,
    regulation: "DPDP Act 2023 §4 · GDPR",
    confidence: "HIGH",
  ...
  },
  {
    ...
    dpdpCategory: "Personal Data — Location (DPDP §4)",
    isSpecialCategory: false,
    regulation: "DPDP Act 2023 §4",
    confidence: "MEDIUM",
  ...
  },
  {
    ...
    dpdpCategory: "Personal Data — Security Credential (DPDP §4)",
    isSpecialCategory: false,
    regulation: "DPDP Act 2023 §4 · CERT-In",
    confidence: "HIGH",
...
const VALUE_PATTERNS: ValuePattern[] = [
  ...
  },
  {
    ...
    dpdpCategory: "Sensitive Personal Data — Financial (DPDP §8)",
    isSpecialCategory: true,
    regulation: "DPDP Act 2023 §8 · PCI-DSS",
    ...
    return ok({
      ...
      summary: {
        ...
        dpdpObligations:
          piiCount > 0
            ? [
                "Obtain valid consent before processing (DPDP §6)",
                "Implement purpose limitation (DPDP §7)",
                "Respond to data principal rights requests (DPDP §11–13)",
                specialCount > 0
                  ? "Sensitive personal data requires explicit, specific consent (DPDP §8)"
                  : null,
              ].filter(Boolean)
            : [],
      },
